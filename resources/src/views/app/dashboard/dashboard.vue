    ...
    <b-row>
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          <img style="width: 25%;" src="https://cdn-icons-png.flaticon.com/512/5412/5412646.png"/>  
          <div class="content">
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          <img style="width: 25%;" src="https://cdn-icons-png.flaticon.com/512/10103/10103202.png"/>  
          <div class="content">
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          <img style="width: 25%;" src="https://cdn-icons-png.flaticon.com/512/6569/6569293.png"/>  
          <div class="content">
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          <img style="width: 25%;" src="https://cdn-icons-png.flaticon.com/512/2936/2936758.png"/> 
          <div class="content">

<template>
    <div class="main-content">
        ...
        <b-card class="wrapper" v-if="!isLoading">
            <vue-good-table mode="remote" :columns="columns" :totalRows="totalRows" :rows="brands" @on-page-change="onPageChange" @on-per-page-change="onPerPageChange" @on-sort-change="onSortChange" @on-search="onSearch" :search-options="{
                enabled: true,
...
export default {
    ...
    methods: {
        ...
        Create_Brand() {
            ...
            self.data.append("shop_id", self.brand.shop_id);

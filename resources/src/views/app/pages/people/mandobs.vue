<template>
  <div class="main-content">
    <breadcumb :page="$t('MandobManagement')" :folder="$t('Mandobs')"/>
      ...
      >
        ...
        <div slot="table-actions" class="mt-2 mb-3">
          ...
          <b-button
            ...
            size="sm"
            variant="info m-1"
            v-if="currentUserPermissions && currentUserPermissions.includes('mandobs_import')"
          >
          ...
          <b-button
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('Mandobs_add')"
          >
            <i class="i-Add"></i>
            {{$t('Add')}}
          </b-button>
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            ...
            <a
              ...
              v-if="currentUserPermissions && currentUserPermissions.includes('Mandobs_edit')"
              title="Edit"
              v-b-tooltip.hover
            >
            ...
            <a
              title="Delete"
              v-b-tooltip.hover
              v-if="currentUserPermissions && currentUserPermissions.includes('Mandobs_delete')"
    ...
    <b-sidebar id="sidebar-right" :title="$t('Filter')" bg-variant="white" right shadow>
      <div class="px-3 py-2">
        <b-row>
          <!-- Code Mandob   -->
          <b-col md="12">
            <b-form-group :label="$t('MandobCode')">
          ...
          <!-- Name Mandob   -->
          <b-col md="12">
            <b-form-group :label="$t('MandobName')">
    ...
    <!-- Modal Create & Edit Mandob -->
    <validation-observer ref="Create_Mandob">
      <b-modal hide-footer size="lg" id="New_Mandob" :title="editmode?$t('Edit'):$t('Add')">
    ...
    <!-- Modal Show Mandob Details -->
    <b-modal ok-only size="md" id="showDetails" :title="$t('MandobDetails')">
      <b-row>
    ...
    <b-modal ok-only ok-title="Cancel" size="md" id="importClients" :title="$t('Import_Mandobs')">
...
export default {
  ...
  methods: {
    ...
    clients_PDF() {
      ...
      pdf.text("Mandob List", 40, 25);
      pdf.save("Mandob_List.pdf");
    },
    ...
    clients_Excel() {
      ...
      axios
        ...
        .then(response => {
          ...
          link.href = url;
          link.setAttribute("download", "List_Mandobs.xlsx");

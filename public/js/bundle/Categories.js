          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (valid) {
                  _this3.category.image = e.target.files[0];
                } else {
                  _this3.category.image = "";
                }
                            ...
                            scopedSlots: _vm._u([
                              {
                                ...
                                fn: function (ref) {
                                  ...
                                  return _c(
                                    "b-form-group",
                                    {
                                      attrs: { label: _vm.$t("main_section") },
                                    },
                                    [
                                      _c("v-select", {
                                        class: {
                                        ...
                                        model: {
                                          value: _vm.category.main_section,
                                          callback: function ($$v) {
                                            _vm.$set(
                                              _vm.category,
                                              "main_section",
                                          ...
                                          expression: "category.main_section",
                                        },
                                      }),
                                      _vm._v(" "),

  ...
  methods: {
        ...
        this.timer = setTimeout(function () {
          ...
          if (product_filter.length === 1) {
            ...
            _this6.product_filter = _this6.products.filter(function (product) {
              return product.name.toLowerCase().startsWith(_this6.search_input.toLowerCase()) || product.code.toLowerCase().startsWith(_this6.search_input.toLowerCase()) || product.barcode.toLowerCase().startsWith(_this6.search_input.toLowerCase());
            });
          }
        }, 800);
      } else {
    ...
    processPayment: function processPayment() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _yield$_this8$stripe$, token, error;

        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this8.paymentProcessing = true;
                _context2.next = 3;
                return _this8.stripe.createToken(_this8.cardElement);

              case 3:
                _yield$_this8$stripe$ = _context2.sent;
                token = _yield$_this8$stripe$.token;
                error = _yield$_this8$stripe$.error;
                ...
                if (error) {
                  ...
                  axios.post("sales", {
                    ...
                    payment: _this8.payment,
                    amount: parseFloat(_this8.payment.amount).toFixed(2),
                    received_amount: parseFloat(_this8.payment.received_amount).toFixed(2),
                    change: parseFloat(_this8.payment.received_amount - _this8.payment.amount).toFixed(2),
                    token: token.id
    ...
    Get_Product_Details: function Get_Product_Details(product_id) {
      ...
      axios.get("Products/" + product_id).then(function (response) {
        ...
        _this10.product.fix_price = response.data.fix_price;
        _this10.product.sale_unit_id = response.data.sale_unit_id;
                        ...
                        [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _vm.paymentProcessing ? _vm._m(1) : _vm._e(),
                            ],
                            1
                          ),
                        ],
